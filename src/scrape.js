...
exports.getTomorrowLook = function(tomorrowAverTmp) {
...
exports.createMessage = function(location, todayHighTmp, todayLowTmp, tomorrowHighTmp, tomorrowLowTmp) {
  return {
    type: 'mrkdwn',
    attachments:[
        {
        ...
        fields:[
            ...
            value: 
  `-\n
  오늘 ${location}은 *최고 ${this.todayHighTmp}°, 최저 ${this.todayLowTmp}°* 였으며,\n
